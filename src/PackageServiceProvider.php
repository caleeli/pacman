...
namespace JDD\Pacman;

use App\Menu;
use App\User;
use Illuminate\Support\ServiceProvider;
use JDD\Pacman\Console\Commands\UpdatePackage;
use JDD\Pacman\Console\Commands\AddRepository;

class PackageServiceProvider extends ServiceProvider
{
    const PluginName = 'jdd/pacman';
    ...
    public function boot()
    {
        ...
        $this->commands([UpdatePackage::class, AddRepository::class]);
        // Publish vendors
        $this->publishes([
            // Publish assets
        ...
        app('config')->push('l5-swagger.paths.annotations', __DIR__ . '/Http/Controllers');
        app('config')->push('l5-swagger.paths.annotations', __DIR__ . '/Http/Resources');
        // Regiter menus
    ...
    public static function registerMenus(array $menus, User $user)
    {
        /*$menus[] = [
            ...
            'action' => 'this.$router.push("/pacman")',
        ];*/
        return $menus;
    }
}
